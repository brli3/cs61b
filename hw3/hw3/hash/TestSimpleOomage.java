...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        ...
        SimpleOomage ooD = new SimpleOomage(10, 10, 10);
        HashSet<SimpleOomage> hashSet = new HashSet<>();
        hashSet.add(ooA);
        assertTrue(hashSet.contains(ooA2));
        assertFalse(hashSet.contains(ooB));
        assertFalse(hashSet.contains(ooC));
        assertFalse(hashSet.contains(ooD));
        assertTrue(ooA.hashCode() == ooA2.hashCode());
        assertTrue(ooA.hashCode() != ooB.hashCode());
        assertTrue(ooA.hashCode() != ooC.hashCode());
        assertTrue(ooA.hashCode() != ooD.hashCode());
    }
